      ...
      <View>
        ...
        >
          <View styles={styles.inrow}>
            ...
            <TouchableHighlight
              onPress={() => Linking.openURL("http://facebook.com/$`{title}`")}
            >
              <Image style={styles.button} source={require("./fb.png")} />
            </TouchableHighlight>
            <TouchableHighlight
              onPress={() => Linking.openURL("http://instagram.com/$`{title}`")}
            >
              <Image style={styles.button} source={require("./ins.png")} />
            </TouchableHighlight>
            <TouchableHighlight
              onPress={() => Linking.openURL("http://linkedin.com/$`{title}`")}
            >
              <Image style={styles.button} source={require("./in.png")} />
            </TouchableHighlight>
            <TouchableHighlight
              onPress={() => Linking.openURL("http://snapchat.com/$`{title}`")}
            >
              <Image style={styles.button} source={require("./sc.png")} />
            </TouchableHighlight>
            <TouchableHighlight
              onPress={() => Linking.openURL("http://twitter.com/$`{title}`")}
            >
